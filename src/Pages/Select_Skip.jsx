...
export const Select_Skip = () => {
  ...
  return (
    <div className="flex-1 p-8 mt-12 sm:mt-12 sm:p-6 md:p-8 ml-0 md:ml-60 md:mt-0 lg:mt-0 bg-neutral-700/50 backdrop-blur-sm min-h-screen">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-5 relative">
        {error ? (
